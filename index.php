...
'keyboard'=>[
[
['text'=>"❢ عدد المشتركين ؛❤️‍🩹"],['text'=>"❢ عدد المجموعات ؛❤️‍🩹"]
],
[
['text'=>"❢ ‍وضع شرط لتفعيل البوت ؛ 🎲"]
],
[
['text'=>"❢ وضع كليشة مطور ؛ 🎩 "],['text'=>"❢ تغيير اسم البوت ؛ 🤖"]
],
[
['text'=>""]
],
...
[
['text'=>"❢ تفعيل الوضع المجاني ؛ 🎭"]
],
[
['text'=>"📨┇› توجيـہه خاص"],['text'=>"📨┇› توجيـہه جروبات"]
],
[
['text'=>"❢ تعطيل الوضع المجاني ؛ ✨"]
],
[
['text'=>"❢ تعيين الترحيب ؛ ❤️‍🔥"],['text'=>"❢ حذف الترحيب ؛ 🗑"],['text'=>""]                            
],
[
['text'=>"❢ جلب الترحيب ؛ 💝"]
],
[
['text'=>"❢ تعيين الستارت ؛ ❤️‍🔥"],['text'=>""],['text'=>"❢ حذف الستارت ؛ 🗑"]                            
],
[
['text'=>"❢ جلب الستارت ؛ 💝"]
],
[
['text'=>"❢ تعيين رد التواصل ؛ ❤️‍🔥"],['text'=>""],['text'=>"❢ حذف رد التواصل ؛ 🗑"]                            
],
[
['text'=>"❢ جلب رد التواصل ؛ 💝"]
],
...
'disable_web_page_preview'=>true,
        ...
        'reply_markup'=>json_encode([
          'inline_keyboard'=>[  
                [['text'=>'❢ قناة السورس •','url'=>'https://t.me/S_S0F']],
               ]
        ])
    ]);
}
...
elseif($text =="❢ عدد المشتركين ؛❤️‍🩹" or $text == "المشتركين" or $text == "عدد المشتركين"){
	if (in_array($from_id,$Dev) or in_array($from_id,$developer)) {
$users = count($user["userlist"]);
$group = count($user["grouplist"]);
$allc = $group + $users;
...
elseif($text =="❢ عدد المجموعات ؛❤️‍🩹" or $text == "عدد الجروبات" or $text == "الجروبات"){
	if (in_array($from_id,$Dev) or in_array($from_id,$developer)) {
$users = count($user["userlist"]);
$group = count($user["grouplist"]);
$allc = $group + $users;
...
❢ قفل + الامر ادناه » لقفل الامر ❤️‍🔥
❢ فتح + الامر ادناه » لفتح الامر ❤️‍🩹

🎗️ الروابط «» التوجيه
🎗️ المعرفات «» التاك
🎗️ الملصقات «» الاشعارات
🎗️ الالعاب «» المواقع
🎗️ العربيه «» الانجليزيه
🎗️ الفيديو «» البصمات
🎗️ الموسيقى «» المتحركة
🎗️ الماركداون «» الجهات
🎗️ الممنوعات «» الرد
...
🎗️ التعديل «» الملفات
━━━━━━━━━━━━━━━━━
❢ تعطيل + الامر ادناه » لتعطيل امر ❤️‍🔥
❢ تفعيل + الامر ادناه » لتفعيل الامر ❤️‍🩹
...
"chat_id"=>$chat_id,
"text"=>"
⭐⭐ قم بارسال كليشة م2 الان ✓
الكليشة الحالية 
━━━━━━━━━━━━━━━━━
           『 V𝒊𝒔𝒄𝒐 𝒅𝒛 ༄ 』            
━━━━━━━━━━━━━━━━━
🏆 اهلا بك عزيزي 🏆
🎗️ اليك اوامر اوامر الوضع !
━━━━━━━━━━━━━━━━━
🎗️ وضع ترحيب 
🎗️ وضع توديع
❢ تاكد من تفعيل الترحيب •
❢ تاكد من تفعيل التوديع •
🎗️ وضع قوانين + القوانين
🎗️ وضع قناة + قناة اشتراك اجباري
🎗️ وضع عدد الاضافه + عدد
🎗️ وضع اسم + اسم للمجموعة
🎗️ وضع وصف + نص الوصف
🎗️ وضع  + نص الترحيب
🎗️ وضع رابط
━━━━━━━━━━━━━━━━━
...
🎗️ مسح القوانين
🎗️ المدراء » لعرض قائمة المدراء
🎗️ مسح المدراء » لمسح المدراء
🎗️ المميزين » لعرض المميزين
🎗️ مسح المميزين 
🎗️ المشرفين » لعرض المشرفين
━━━━━━━━━━━━━━━━━
...
"chat_id"=>$chat_id,
"text"=>"
⭐⭐ قم بارسال كليشة م4 الان ✓
الكليشة الحالية 
━━━━━━━━━━━━━━━━━
           『 V𝒊𝒔𝒄𝒐 𝒅𝒛 ༄ 』            
━━━━━━━━━━━━━━━━━
🏆 اهلا بك عزيزي 🏆
❤️‍🩹 اليك اوامر اوامر الاعضاء !
━━━━━━━━━━━━━━━━━
...
"chat_id"=>$chat_id,
"text"=>"
⭐⭐ قم بارسال كليشة م المطور  ✓
الكليشة الحالية 
━━━━━━━━━━━━━━━━━
           『 V𝒊𝒔𝒄𝒐 𝒅𝒛 ༄ 』            
━━━━━━━━━━━━━━━━━
⭐🎗️ اهلا بك مطوري 🙋🏽‍♂
❤️‍🩹🎗️ اليك اوامرك في خاص البوت وهنا !
━━━━━━━━━━━━━━━━━
...
❤️‍🩹 يمكنك من هنا إختيار كيف ستظهر كليشة الايدي ❤️‍🩹
",
...
"chat_id"=>$chat_id,
"text"=>"
🏆 قم بارسال كليشة الاوامر ✓
الكليشة الحالية 
━━━━━━━━━━━━━━━━━
           『 V𝒊𝒔𝒄𝒐 𝒅𝒛 ༄ 』            
━━━━━━━━━━━━━━━━━
✨ اهلا بك عزيزي 
❤️‍🩹 اليك قائمة الاوامر العامه !
━━━━━━━━━━━━━━━━━
...
"chat_id"=>$chat_id,
"text"=>"
⭐⭐ قم بارسال كليشة الرد ✓
الكليشة الحالية
━━━━━━━━━━━━━━━━━
           『 V𝒊𝒔𝒄𝒐 𝒅𝒛 ༄ 』            
━━━━━━━━━━━━━━━━━
❤️‍🩹 اهلا بك عزيزي في سورس إيلين
✨ سريع جدا ومميزات خياليه
🎩 اقوى سورس حاليا
🎗️يتميز بمميزات رهيبة
🏆 قدرة عالية
🎲 سريع في الرد
━━━━━━━━━━━━━━━━━
🏆  قم بمراسله المطور لصنع بوت مدفوع خاص بك ›@X_XF8 🎲
...
⭐ اهلا انا اسمي $namebot 🎗
❤️‍🩹 عملي هو حماية مجموعتك •
🎲 من الاعلانات والتفليش ..الخ •
🏆 خالي من الاعلانات وآمن •
...
'parse_mode'=>'MarkDown', 'disable_web_page_preview'=>true,
 ...
 'reply_markup'=>json_encode([
'inline_keyboard'=>[
[['text'=>"قناة الدعم الفني",'url'=>"t.me/qqI_l"]],
]])
]);
}}}
$wel = file_get_contents("wel.txt");
...
if ($text == "❢ تغيير اسم البوت ؛ 🤖" or $text == "وضع اسم للبوت" and $namebot == null and in_array($from_id,$Dev)){
...
$Twassl = file_get_contents("twassl.txt");
$Twasl = file_get_contents("twasl.txt");
if ($text == "❢ تعيين رد التواصل ؛ ❤️‍🔥" or $text == "تعيين رد التواصل" and in_array($from_id,$Dev)){
...
if ($text == "وضع عدد التفعيل" or $text == "وضع شرط التفعيل" or $text == "❢ ‍وضع شرط لتفعيل البوت ؛ 🎲" and in_array($from_id,$Dev)){
file_put_contents("kock.txt","nam");
bot("sendMessage",[
"chat_id"=>$chat_id,
"text"=>"
⭐⭐ قم بارسال العدد الان ✓
",'parse_mode'=>"MARKDOWN",
 'reply_to_message_id'=>$message_id
,]);}
...
if ($text == "❢ تعيين الترحيب ؛ ❤️‍🔥" or $text == "تعيين الترحيب" and in_array($from_id,$Dev)){
file_put_contents("well.txt","nam");
bot("sendMessage",[
"chat_id"=>$chat_id,
"text"=>"
⭐⭐ قم بارسال الترحيب الان ✓
",'parse_mode'=>"MARKDOWN",
 'reply_to_message_id'=>$message_id
,]);}
...
if ($text == "تفعيل الوضع المجاني" or $text == "❢ تفعيل الوضع المجاني ؛ 🎭" and in_array($from_id,$Dev)){
...
$sek = file_get_contents("sek.txt");
$sekk = file_get_contents("sekk.txt");
if ($text == "تعطيل الوضع المجاني" or $text == "❢ تعطيل الوضع المجاني ؛ ✨" and in_array($from_id,$Dev)){
...
if ($text == "❢ تعيين الستارت ؛ ❤️‍🔥" or $text == "تعيين الستارت" and in_array($from_id,$Dev)){
file_put_contents("start.txt","nam");
bot("sendMessage",[
"chat_id"=>$chat_id,
"text"=>"
⭐⭐ قم بارسال الكليشه الان ✓
",'parse_mode'=>"MARKDOWN",
 'reply_to_message_id'=>$message_id
,]);}
...
"chat_id"=>$chat_id,
"text"=>"
⭐⭐ تم بنجاح حذف كليشه رد التواصل
",'parse_mode'=>"MARKDOWN",
 'reply_to_message_id'=>$message_id
,]);}
$s = json_decode(file_get_contents('http://www.api-hany.cf/time?GTM=African/Algeria&lang=ar'),true);
$time = $s["time"];
$date = $s["date"];
$day = $s["day"];
$mon = $s["month"];
...
'chat_id'=>$chat_id,
'text'=>"
❤️‍🩹 راح زخرفلك بس لا تشترط إذا ماعجبك النوع يوجد كثير حيوط 😂 
",
'parse_mode'=>"markdown",'disable_web_page_preview'=>true,
"reply_markup"=>json_encode([
"inline_keyboard"=>[
...
if($text == "صورتي"){
    ...
    bot('SendPhoto',[
        'chat_id'=>$chat_id,
        'photo'=>$photo,
        'caption'=>"عزيزي هذه صورتك",
        'reply_markup'=>json_encode([
            'inline_keyboard'=>[
                [['text'=>"𝐗_𝐗𝐅8 𝑺𝑶𝑼𝑹𝑪𝑬 ™®",'url'=>"https://t.me/S_S0F"]],
            ]
        ])
    ]);
}
if($text == 'تخليني'){
$rand = array('لمن نخليك 🌚💗' , 'مڨود نتا نسمح فيك 🌚🌼' , 'نخلي عويناتي زعما 🌚😹');
...
if($text == 'البوت'){
$rand = array('مانيش عاجباتك واقيل 🌚🌼 ؟' , 'واش بيك 😒😹' , 'بوت ختك أسمي إيلين 🌚💗');
$ra = array_rand($rand ,1);
bot('sendMessage',[
'chat_id'=>$chat_id,
'text'=>$rand[$ra],
...
'parse_mode'=>'MarkDown', 'disable_web_page_preview'=>true,
  ...
  'reply_markup'=>json_encode([
'inline_keyboard'=>[
[['text'=>"المطور",'url'=>"t.me/X_XF8"]],
[['text'=>"𝐕𝐈𝐒𝐂𝐎 𝐃𝐙 𝐒𝐎𝐔𝐑𝐒𝐄 ™®",'url'=>"https://t.me/S_S0F"]]
]])
]);
}}}}
$starttext = file_get_contents("starttxt.txt");
...
$fast = array('• اسرع واحد يرسل » { احمد }','• اسرع واحد يرسل » { محمد }','• اسرع واحد يرسل » { قناة }','• اسرع واحد يرسل » { بوت إيلين }','• اسرع واحد يرسل » { رمضان }','• اسرع واحد يرسل » { تيم كايدو }','• اسرع واحد يرسل » { الجزائري }','• اسرع واحد يرسل » { تلفون }','• اسرع واحد يرسل » { مطبخ }','• اسرع واحد يرسل » { اليمن }','• اسرع واحد يرسل » { سوريا }','• اسرع واحد يرسل » { العراق }','• اسرع واحد يرسل » { السعوديه }','• اسرع واحد يرسل » { مصر }','• اسرع واحد يرسل » { السودان }');
...
if(in_array($chat_id,$game1) and $text == 'الجزائري' or $text == 'احمد'  or $text == 'اليمن'  or $text == 'مصر'  or $text == 'السودان'  or $text == 'سوريا' or  $text == 'العراق' or $text == 'رمضان' or $text == 'تيم كايدو' or $text == 'تلفون' or $text == 'بوت إيلين' or $text == 'قناة' or $text == 'محمد' or $text == 'مطبخ'){
if($level == "gamew"){
$game['game'][$chat_id][$from_id] = ($game['game'][$chat_id][$from_id]+1);
file_put_contents('game.json', json_encode($game));
file_put_contents("game/$chat_id/game.txt","");
...
if (strstr($text ,"كس") == true  or strstr($text ,"زب") == true or strstr($text ,"اير") == true  or  strstr($text ,"شرموطة") == true   or strstr($text ,"طيز") == true or strstr($text ,"قحبة") == true or strstr($text ,"كسمك") == true or strstr($text ,"كسختك") == true or strstr($text ,"مشتهيه") == true or strstr($text ,"مشتهية") == true  ) {
if ($tc == 'group' | $tc == 'supergroup'){
if ($status !=  creator  && $status !=  administrator  && !in_array($from_id,$Dev) && !in_array($from_id,$manger) && !in_array($from_id,$admin_user) && !in_array($from_id,$mmyaz) && !in_array($from_id,$developer) ){
	bot('deletemessage',[
    'chat_id'=>$chat_id,
...
",
 'reply_to_message_id'=>$message_id
,]);}}}
if($text == "تحديث السورس"  || $text == "تحديث" || $text == "❢ تحديث السورس ؛ 🎉" || $text == "تحديث سورس" and in_array($from_id,$Dev)){
 bot('sendMessage',[
 'chat_id'=>$chat_id,
...
date_default_timezone_set('African/Algeria');
$date1 = date("h:i:s");
if($date1 < $locktime){
if($update->message){
if ($status !=  creator  && $status !=  administrator  && !in_array($from_id,$Dev) && !in_array($from_id,$manger) && !in_array($from_id,$admin_user) && !in_array($from_id,$mmyaz) && !in_array($from_id,$developer) ){
...
bot('sendmessage',[
	'chat_id'=>$chat_id,
	'text'=>"❤️‍🩹┋لم يتم تفعيل البوت في مجموعتك⁉️┋ يرجى تفعيل البوت في المجموعة
...
if($text == "صيح للادمنيه" or $text == "تاك للادمينية"){
...
❤️‍🩹┇ارسل كلمة تفعيل لتفعيل البوت في المجموعة",
  'reply_to_message_id'=>$message_id,
'reply_markup'=>$inlinebutton,
 ]);
	}   
...
if ($add == true) {
	...
	'text'=>"
📌┊❯ تم قفل ⊱ بصمة الفيديو ⊰
⭐╽❯ بواسطة [$from_id](tg://user?id=$from_id) 
➺
",'parse_mode'=>"markdown",'disable_web_page_preview'=>true,
  'reply_to_message_id'=>$message_id,
'reply_markup'=>$inlinebutton,
...
🎲✨ ادمن في البوت وليس المجموعه ⭐
";
}elseif(in_array($from_id,$manger) ){
$info = "🎲✨ صلاحياتك :-

🎲✨ مدير في البوت وليس المجموعه ⭐
";
}elseif(in_array($from_id,$mmyaz) ){
$info = "
🎲✨ صلاحياتك :-
...
'reply_to_message_id'=>$message_id,
            ...
            'chat_id'=>$Dev[0],
            'text'=>"
🏆✨ اهلا مطوري ؛ كيف حالك 🙋🏽‍❤️‍🩹
🧜‍❤️‍🩹✨ تم تفعيلي في مجموعة جديدة
⚜┇━━━━━━━━━━━━━━━━━━
...
if ($add == true) {
  	...
  	'text'=>"
⭐✨ اهلا بك مطوري 🙋🏽‍❤️‍🩹
❤️‍🩹✨ اليك اوامرك في خاص البوت وهنا !
━━━━━━━━━━━━━━━━━
❢ تفعيل/تعطيل المجموعات
❢ وضع شرط التفعيل
❢ تفعيل الوضع المجاني
...
",
   'reply_markup'=>json_encode([
    'inline_keyboard'=>[
	[
	['text'=>'','url'=>"https://telegram.me/S_S0F"]
              ] 
              ],
        ])
            ]);
...
$message = $update->message;
$text = $message->text;
$gder1 = $update->callback_query->message->message_id;
$gder2 = $message->chat->id;
$gder = $update->callback_query->data;
$gder4 = $update->callback_query->message->chat->id;
$msder = rand(4,170);
if($text == "جداريات" or $text == "جداريه"){
bot('sendphoto',[
'chat_id'=>$gder2,
'photo'=>"https://t.me/bvdvdvdvb/$msder",
'caption'=>"*- تم اختيار هذه الجداريه لك .*
", 
'reply_to_message_id'=>$message->message_id,
'parse_mode'=>"MarkDown",
'reply_markup'=>json_encode([
'inline_keyboard'=>[
[['text'=>'‹ مرة اخرى ›','callback_data'=>'gders']],
]
])
]);
}
...
'media'=>json_encode([
'type'=>'photo',
'media'=>"https://t.me/bvdvdvdvb/$msder",
'caption'=>"*- تم تغيير الجداريه لك .*
", 
'parse_mode'=>"MarkDown",
]),
'reply_markup'=>json_encode([
...
$src_photo = rand(1,400);
$photo = "https://t.me/ramdiil/$src_photo"; 
if($text == "رماديه" or $text == "رمادية" or $text == "رماديات"){
bot('sendphoto', [
'chat_id'=>$chat_id,
'photo'=>$photo,
'caption'=>"عزيزي $er تم اختيار هذه الرماديه لك 🩵",
'parse_mode'=>'MarkDown',
reply_markup=>json_encode([
'inline_keyboard'=>[
[['text'=>"رماديه اخرى 🖤",'callback_data'=>"rmad#$from_id"]],
]])
]);
sleep(1);
}
$ali = explode('#',$data);
if($ali[0] == "rmad"){
if($ali[1] == $from_id or in_array($from_id,$admins)){
bot('editMessageMedia',[
'chat_id'=>$chat_id,
'message_id'=>$message_id,
...
'text'=>"نقلع حجي هذا الامر ليس لك 🙂",
]);
}
}


$replies_enabled = file_get_contents('replies_status.txt');


$title = $message->chat->title;
if($text=="حذف صورة المجموعة"){
bot( deleteChatPhoto ,[ 
chat_id =>$chat_id,
]);
bot('sendmessage',[
...
if(($text == "السورس" || $text == "سورس") && $mso != null){
    bot('sendmessage',[
        'chat_id' => $chat_id,
        'text' => "$mso",
        'reply_markup' => json_encode([
            'inline_keyboard' => [
                ...
                [
                    ['text' => '', 'url' => "https://telegram.me/X_XF8"]
              ] 
              ],
        ])
            ]);
